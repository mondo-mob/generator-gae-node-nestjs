...
module.exports = class extends Generator {
  ...
  writing() {
    ...
    copyTpl('module.ts', `server/src/${this.props.moduleSlugged}/${this.props.moduleSlugged}.module.ts`);

    copyTpl('service.ts', `server/src/${this.props.moduleSlugged}/${this.props.moduleSlugged}.service.ts`);

    if (this.props.includeRepository) {
      copyTpl('repository.ts', `server/src/${this.props.moduleSlugged}/${this.props.moduleSlugged}.repository.ts`);
    }

    if (this.props.includeGraphQL) {
      copyTpl('resolver.ts', `server/src/${this.props.moduleSlugged}/${this.props.moduleSlugged}.resolver.ts`);

      copyTpl('schema.graphqls', `server/src/${this.props.moduleSlugged}/${this.props.moduleSlugged}.graphqls`);
    }
  }
